...
SELECT s.staff_id, s.first_name, s.last_name, s.email FROM sales.staffs s WHERE store_id = 1 AND active = 1;
...
-- Write your query below:
SELECT product_id, product_name, category_id, list_price FROM production.products ORDER BY category_id, list_price DESC;
...
-- Write your query below:
SELECT * FROM sales.customers ORDER BY last_name OFFSET 10 ROWS FETCH NEXT 10 ROWS ONLY;
...
-- Part a:
SELECT DISTINCT * FROM production.products WHERE list_price > 1000;
...
-- Part b:
SELECT order_id, store_id, order_date FROM sales.orders WHERE store_id !=2;
...
-- Write your query below:
SELECT product_name, model_year, list_price FROM production.products WHERE (list_price >= 300 AND list_price <= 1200) AND model_year IN (2017, 2018) ORDER BY list_price;
...
-- Write your query below:
SELECT first_name + ' ' + last_name as full_name, email FROM sales.customers WHERE email like '%gmail.com' ORDER BY full_name;
